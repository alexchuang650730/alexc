...
parser.add_argument("--train-epoch-steps", type=int, default=20000000, help="how many steps (=4 frames) to run during a training epoch (approx -- will finish current game)")
parser.add_argument("--eval-epoch-steps", type=int, default=20, help="how many steps (=4 frames) to run during an eval epoch (approx -- will finish current game)")
...
parser.add_argument("--save-model-freq", type=int, default=2000, help="save the model once per 10000 training sessions")
...
parser.add_argument("--tesing", action='store_true')
